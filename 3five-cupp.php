			    ...
			    <td>
				    ...
				    <div id="current_img">
					    <?php if ( $cupp_upload_url ): ?>
						    ...
						    <div class="edit_options uploaded">
							    ...
							    <a href="<?php echo esc_url( $cupp_upload_edit_url ); ?>" class="edit_img" target="_blank"><span>Edit</span></a>
						    </div>
					    <?php elseif ( $cupp_url ) : ?>
					    ...
					    <?php else : ?>
						    <img src="<?php echo esc_url( plugins_url( 'custom-user-profile-photo/img/placeholder.gif' ) ); ?>"
				    ...
				    <div id="cupp_upload">
					    ...
					    <input type="hidden" name="cupp_upload_meta" id="cupp_upload_meta"
					           value="<?php echo esc_url_raw( $cupp_upload_url ); ?>" class="hidden" />
					    <input type="hidden" name="cupp_upload_edit_meta" id="cupp_upload_edit_meta"
					           value="<?php echo esc_url_raw( $cupp_upload_edit_url ); ?>" class="hidden" />
					    <input type='button' class="cupp_wpmu_button button-primary"
					           value="<?php _e( esc_attr( $btn_text ), 'custom-user-profile-photo' ); ?>" id="uploadimage" /><br />
				    </div>
				    <!-- Outputs the text field and displays the URL of the image retrieved by the media uploader -->
				    <div id="cupp_external">
					    <input type="text" name="cupp_meta" id="cupp_meta"
					           value="<?php echo esc_url_raw( $cupp_url ); ?>" class="regular-text" />
				    </div>
...
function cupp_save_img_meta( $user_id ) {
	...
	// @codingStandardsIgnoreStart TODO: filter and sanitize $_POST data
